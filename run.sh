...
do
    ...
    ./target/release/examples/gg18_sign_client http://127.0.0.1:8001 keys$i.store $price &
    sleep 3
done

echo "submitting price with signature"
./target/release/examples/submit_price $price
